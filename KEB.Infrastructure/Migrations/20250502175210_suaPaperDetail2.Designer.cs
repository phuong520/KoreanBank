...
namespace KEB.Infrastructure.Migrations
{
    ...
    [Migration("20250502175210_suaPaperDetail2")]
    partial class suaPaperDetail2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KEB.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasIndex("AttachFileId")
                        .IsUnique()
                        .HasFilter("[AttachFileId] IS NOT NULL");
            ...
            modelBuilder.Entity("KEB.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            NotificationId = new Guid("d511b5a2-02b3-4e6e-8d1c-583cafc8195e"),
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            NotificationId = new Guid("901a909c-9895-42d3-b316-5795ed8ccc72"),
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            NotificationId = new Guid("664dee79-a16b-4553-b359-d79371fd9891"),
            ...
            modelBuilder.Entity("KEB.Domain.Entities.PaperDetail", b =>
                {
                    b.HasOne("KEB.Domain.Entities.ImageFile", "Attachment")
                        .WithOne("PaperDetail")
                        .HasForeignKey("KEB.Domain.Entities.PaperDetail", "AttachmentId")
            ...
            modelBuilder.Entity("KEB.Domain.Entities.Question", b =>
                {
                    b.HasOne("KEB.Domain.Entities.ImageFile", "AttachmentFile")
                        .WithOne("Question")
                        .HasForeignKey("KEB.Domain.Entities.Question", "AttachFileId")
                        .OnDelete(DeleteBehavior.NoAction);
